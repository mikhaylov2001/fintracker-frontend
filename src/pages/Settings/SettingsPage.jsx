        ...
        <Box>
          ...
          <RowItem>
            ...
            <Box sx={{ flex: 1, minWidth: 0 }}>
              ...
              <Typography
                variant="body2"
                sx={{ color: alpha("#fff", 0.6), fontWeight: 700 }}
              >
          ...
          <RowItem>
            ...
            <Box sx={{ flex: 1 }}>
              <Typography sx={{ fontWeight: 900, color: colors.text, fontSize: 15 }}>
                Email
              </Typography>
              <Typography
                variant="body2"
        ...
        <Box>
          ...
          <RowItem noDivider>
            ...
            <Box sx={{ flex: 1 }}>
              ...
              >
                Данные хранятся в базовой валюте, здесь только отображение и
                конвертация.
              </Typography>
        ...
        <Box>
          ...
          <RowItem noDivider>
            ...
            <Box sx={{ flex: 1 }}>
              ...
              <Typography
                variant="body2"
                sx={{ color: alpha("#fff", 0.6), fontWeight: 700, mb: 2 }}
              >
      ...
      >
        ...
        <DialogContent dividers>
          <Stack spacing={2.5} sx={{ pt: 1 }}>
            ...
            <Box>
              <Typography sx={{ fontWeight: 900, mb: 1, fontSize: 14 }}>
                Что удалить:
              </Typography>
              <FormGroup>
                <FormControlLabel
