  ...
  return (
    <Box sx={pageBackgroundSx}>
      ...
      >
          ...
          >
            ...
            <Button
              ...
              sx={{
                ...
                fontWeight: 800,
                textTransform: "none",
                boxShadow: `0 12px 30px ${alpha(bankingColors.primary, 0.45)}`,
        ...
        {/* Table / список — без белого «квадрата» и без линий */}
                  ...
                  <TableRow key={x.id} hover>
                    ...
                    <TableCell align="right" sx={{ whiteSpace: "nowrap" }}>
                      <IconButton
                        ...
                        sx={{
                          color: bankingColors.muted,
                          "&:hover": { color: bankingColors.text },
                        }}
                      >
                      ...
                      <IconButton
                        ...
                        size="small"
                        sx={{
                          color: alpha(bankingColors.danger, 0.85),
                          "&:hover": { color: bankingColors.danger },
                        }}
                      >
        ...
        {/* Dialog — не fullScreen, без «рамки страницы» */}
        <Dialog
          fullScreen={false}
          scroll="paper"
          open={open}
