...
export default function FtDatePicker({ value, onChange, maxDate, minDate, placeholder = "Выберите дату" }) {
        ...
        >
          ...
          <div className="flex justify-between mt-4 pt-3 border-t border-border">
            ...
            <button
              type="button"
              onClick={() => pick(today)}
              className="text-xs font-semibold text-emerald-glow hover:brightness-110"
            >
              Сегодня
            </button>
          </div>
